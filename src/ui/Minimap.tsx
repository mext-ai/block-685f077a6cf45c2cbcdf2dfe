...
export function Minimap({ size = 200 }): JSX.Element {
  ...
  const mask = useTexture('https://content.mext.app/uploads/ca6d6648-7d03-4cb2-a106-f3cbc72167ab.svg')
  const cursor = useTexture('https://content.mext.app/uploads/4a5f4d12-99d4-416d-8408-b3b6ef70353b.svg')
