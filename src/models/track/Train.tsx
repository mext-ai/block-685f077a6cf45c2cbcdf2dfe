...
export function Train({ args = [38, 8, 10], position = [-145.84, 3.42, 54.67], rotation = [0, -0.09, 0] }: BoxProps): JSX.Element {
  ...
  const { animations, nodes: n, materials: m } = useGLTF('https://content.mext.app/uploads/c9050d26-971c-47be-aeca-4d12261b64a8.glb') as TrainGLTF
  ...
  return (
    <group ref={ref} name="train" position={position} rotation={rotation} dispose={null}>
      ...
      {sound && ready && <PositionalAudio url="https://content.mext.app/uploads/52f8d15d-0674-473f-ab6b-82738fb3245b.mp3" loop autoplay distance={5} />}
    </group>
  )
}
